...
if ($stmt_verifica_respostas) {
    ...
    if ($total_respostas > 0) {
        // Cliente já respondeu ao formulário, redireciona
        echo '<script>';
            ...
            <form id="formulario" method="post" action="salvar_respostas.php" enctype="multipart/form-data">
                <div class="form-header">
                    <div class="title" id="pergunta1">
                        ...
                        <input type="radio" name="estacao" value="Inverno" required> Inverno<br>
                    ...
                    <div class="title hidden" id="pergunta2">
                        <h1>Você tem alguma preferência por perfumes masculino, feminino ou unissex?</h1>
                    ...
                    <div class="title hidden" id="pergunta3">
                        <h1>Você prefere perfumes mais suaves e discretos ou fragrâncias mais intensas e marcantes?</h1>
                        <input type="radio" name="intensidade" value="Suave" required> Suave<br>
                        <input type="radio" name="intensidade" value="Intenso"> Intenso
                    </div>

                    <div class="title hidden" id="pergunta4">
                        <h1>Gosta de notas de frutas em seus perfumes? Se sim, quais frutas você mais gosta?</h1>
                    ...
                    <div class="title hidden" id="pergunta5">
                        <h1>Você gostaria que seu perfume fosse mais apropriado para uso diurno ou noturno?</h1>
                        <input type="radio" name="ocasiao" value="Diurno" required> Diurno<br>
                    ...
                    <div class="title hidden" id="pergunta6">
                        <h1>Você prefere fragrâncias que durem o dia todo ou está mais interessado em opções mais leves e discretas?</h1>
                        <input type="radio" name="durabilidade" value="Duradouro" required> Duradouro<br>
                ...
                <div class="continue-button">
                    <button type="button" onclick="proximaPergunta()">Continuar</button>
                </div>
                <div class="continue-button1">
                    <button type="button" onclick="anteriorPergunta()">Voltar</button>
                </div>
            </form>
                ...
                function proximaPergunta() {
                    ...
                    if (perguntaAtualElement) {
                        ...
                        if (proximaPerguntaElement) {
                            ...
                            // Quando todas as perguntas forem respondidas, envia o formulário automaticamente
