...
$unissex1= 'SELECT * FROM perfume WHERE tipo = "unissex1"';
$unissex2= 'SELECT * FROM perfume WHERE tipo = "unissex2"';
...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="css/unissex.css">
        <link rel="shortcut icon" href="img/logo.ico" type="image/x-icon"> 
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <meta charset="UTF-8"/> 
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Rosemary Gold | Unissex </title>
        <script>
            function link(){
...
// Unissex 1 (Importados) 
$result = mysqli_query($conexao, $unissex1);
...
// Unissex 2 (Nacional)
$result = mysqli_query($conexao, $unissex2);
echo '<p class="titulo1"><b>Melhores Perfumes Nacionais</b></p>';
echo '<section class="container2">';
foreach ($result as $show) {
    $perfume_id = $show['id'];
    $isLoggedIn = isset($_COOKIE["email"]);
