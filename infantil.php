...
$infantil1= 'SELECT * FROM perfume WHERE tipo = "infantil1"';
$infantil2= 'SELECT * FROM perfume WHERE tipo = "infantil2"';
?>
...
<html lang="pt-br">
    <head>
        ...
        <title>Rosemary Gold | Infantil </title>
        <script>
            function link(){
...
// Infantil 1
$result = mysqli_query($conexao, $infantil1);
echo '<p class="titulo1"><b>Melhores Perfumes Infantis</b></p>';
...
// Infantil 2
$result = mysqli_query($conexao, $infantil2);
echo '<section class="container2">';
foreach ($result as $show) {
    $perfume_id = $show['id'];
    $isLoggedIn = isset($_COOKIE["email"]);
